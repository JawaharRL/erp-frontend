  ...
  return (
   ...
   <Formtitle></Formtitle>
    ...
    <div className="academic-container">
       ...
       <Allfields fieldtype="date" value="Date_of_Admission" inputname="date_Of_Admission"fieldpattern="\d{2}/\d{2}/\d{4}" req_flag={true} format={/[^0-9/]/g}/>
         {/* <label htmlFor="Date of Admission">Date of Admission</label>
         <input type="date" name="Date of Admission"  /> */}
       </div>
       <div className="join-date">
       <Allfields fieldtype="date" value="Course_Joined_Date" inputname="course_Joined_Date"fieldpattern="\d{2}/\d{2}/\d{4}" req_flag={true} format={/[^0-9/]/g}/>
